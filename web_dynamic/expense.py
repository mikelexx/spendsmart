...
def delete_expenses():
    ...
    expense_ids = request.form.getlist("expense_ids")
    base_url = "http://127.0.0.1:5001/api/v1/{}/expenses".format(current_user.id)
...
def move_expenses():
    ...
    for expense_id in expense_ids:
        update_expense_url = "http://127.0.0.1:5001/api/v1/{}/expenses/{}".format(current_user.id, expense_id)
